...
Route::get('delete/{id}', [ManualController::class, 'delete'])->name('deletemanual');
...
Route::get('/adminpage', [PagesController::class, 'viewAdmin'])->name('adminpage');
Route::resource('manual', PagesController::class);
